-- Script para desactivar completamente RLS en la tabla users
-- Úsalo solo si el script anterior no funciona
...
SELECT 'RLS desactivado completamente en tabla users!' as status;
