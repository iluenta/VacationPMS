-- ============================================================================
-- SCRIPT 095: MIGRAR USUARIOS EXISTENTES A PERSONAS (VERSIÓN FINAL)
-- ============================================================================
...
ALTER TABLE users DISABLE TRIGGER update_password_changed_at_trigger;

RAISE NOTICE 'Trigger update_password_changed_at_trigger deshabilitado temporalmente';
...
ALTER TABLE users ENABLE TRIGGER update_password_changed_at_trigger;

RAISE NOTICE 'Trigger update_password_changed_at_trigger rehabilitado';
