-- ============================================================================
-- SCRIPT 095: MIGRAR USUARIOS EXISTENTES A PERSONAS (SIN TRIGGERS)
-- ============================================================================
...
-- Deshabilitar todos los triggers en la tabla users
ALTER TABLE users DISABLE TRIGGER ALL;

RAISE NOTICE 'Triggers deshabilitados temporalmente en la tabla users';
...
-- Rehabilitar todos los triggers en la tabla users
ALTER TABLE users ENABLE TRIGGER ALL;

RAISE NOTICE 'Triggers rehabilitados en la tabla users';
