-- ============================================================================
-- SCRIPT 095: MIGRAR USUARIOS EXISTENTES A PERSONAS (VERSIÓN SEGURA)
-- ============================================================================
...
-- ============================================================================
-- MIGRACIÓN DE USUARIOS (EVITANDO TRIGGERS PROBLEMÁTICOS)
-- ============================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- Actualizar el usuario con el ID de la persona (usando UPDATE directo)
        -- Esto evita triggers problemáticos
        EXECUTE format('UPDATE users SET person_id = %L WHERE id = %L', 
                      new_person_id, user_record.id);
